...
@section('content')
<a href="{{ route('tasks.show', $task) }}" class="btn btn-ghost btn-sm" style="margin-bottom:16px;">
    <i class="ti ti-arrow-left"></i> Kembali
</a>

<h1 class="page-title" style="margin-bottom:4px;">Edit Tugas</h1>
<p class="page-subtitle" style="margin-bottom:22px;">Ubah detail tugas sesuai kebutuhan.</p>
